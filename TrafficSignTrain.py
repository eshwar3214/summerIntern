...
path = 'C:/Users/esshwar/PycharmProjects/summerIntern/myData'  # folder with all the class folders
labelFile = 'C:/Users/esshwar/PycharmProjects/summerIntern/labels.csv'  # file with all names of classes
